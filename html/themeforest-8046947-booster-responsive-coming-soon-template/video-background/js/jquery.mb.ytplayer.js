$(window).load(function () {
    ...
    if (e == false) {
        ...
        $("#bg-video-volume").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("fa-volume-off")) {
                n.removeClass("fa-volume-off").addClass("fa-volume-down").attr("title", "Mute");
                t.unmuteYTPVolume();
                t.setYTPVolume(100)
            } else {
                n.removeClass("fa-volume-down").addClass("fa-volume-off").attr("title", "Unmute");
                t.muteYTPVolume()
            }
        });
        $("#bg-video-play").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("fa-pause")) {
                n.removeClass("fa-pause").addClass("fa-play").attr("title", "Play");
                t.pauseYTP()
            } else {
                n.removeClass("fa-play").addClass("fa-pause").attr("title", "Pause");
                t.playYTP()
            }
        })
    } else {
